...
test_input_validation() {
  ...
  assert_failure "Whitespace-only second arg" validate_input "title1" "   " "title2" "body2"
  assert_failure "Whitespace-only third arg" validate_input "title1" "body1" "   " "body2"
  assert_failure "Whitespace-only fourth arg" validate_input "title1" "body1" "title2" "   "
  set -e # Re-enable exit on error
...
run_unit_tests() {
  ...
  ENABLE_LOGGING=false # Disable logging during tests to avoid clutter
  log_init
