...
run_test_suite "Wizard Integration Tests" "$SCRIPT_DIR/test-wizard-integration.sh"
run_test_suite "End-to-End Workflow Tests" "$SCRIPT_DIR/test-end-to-end-workflows.sh"
run_test_suite "Logging Function Tests" "$SCRIPT_DIR/test-logging-functions.sh"
run_test_suite "Wizard Logging Tests" "$SCRIPT_DIR/test-wizard-logging.sh"
run_test_suite "Wizard Logging Integration Tests" "$SCRIPT_DIR/test-wizard-logging-integration.sh"
run_test_suite "Wizard Debug Mode Tests" "$SCRIPT_DIR/test-wizard-debug-mode.sh"
